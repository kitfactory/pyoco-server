...
def test_from_env_parses_values_and_falls_back_on_invalid(monkeypatch):
    ...
    monkeypatch.setenv("PYOCO_YAML_SCHEDULES_KV_BUCKET", "yaml_schedules_test")
    ...
    monkeypatch.setenv("PYOCO_SCHEDULE_POLL_INTERVAL_SEC", "2.5")
    ...
    assert cfg.yaml_schedules_kv_bucket == "yaml_schedules_test"
    ...
    assert cfg.schedule_poll_interval_sec == 2.5
    ...
    monkeypatch.setenv("PYOCO_SCHEDULE_POLL_INTERVAL_SEC", "bad-float")
    ...
    assert cfg2.schedule_poll_interval_sec == NatsBackendConfig.schedule_poll_interval_sec
